...
const prefix = "s/";
client.login("ODA4MDMyNTgyNzI1MTQwNDgw.YCAo_A.aMOYqaStDaXou8r1eAdwaaKlJIQ");
...
> 𝙨/𝙖𝙣𝙩𝙞𝙝𝙖𝙘𝙠 {𝙤𝙣/𝙤𝙛𝙛}
━─╮★╭─━━━─╮★╭─━
__ [𝗜𝗡𝗩𝗜𝗧𝗘 𝘽𝙊𝙏](https://discord.com/api/oauth2/authorize?client_id=738175646299193354&permissions=8&scope=bot) __  __ [𝗦𝗨𝗣𝗣𝗢𝗥𝗧 𝙎𝙍](https://discord.gg/HvvCTx3pxv) __
`);
...
client.on("message", message => {
  ...
  if (message.content.toLowerCase() === prefix + "nick") {
...
client.on("message", msg => {
  if (msg.content === "s/invite") {
    msg.reply(
      "https://discord.com/api/oauth2/authorize?client_id=738175646299193354&permissions=8&scope=bot"
    );
  }
});
client.on("message", msg => {
...
client.on("ready", () => {
  setInterval(() => {
    ...
    client.user.setActivity(
      `s/help ,Users ${client.guilds.cache.reduce(
        (a, g) => a + g.memberCount,
        0
      )}, Guilds ${client.guilds.cache.size}`
    );
